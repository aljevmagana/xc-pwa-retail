...
import '../../assets/svg/orion-svg-sprite.svg'
...
BrandLogoSymbol.viewBox = BrandLogoSymbol.viewBox || '0 0 65 16'
...
export const DeliveryTime = icon('orion-svg-sprite_delivery-time-1')
export const SpriteMoney = icon('orion-svg-sprite_money-1')
export const CustomerSupport = icon('orion-svg-sprite_customer-support-1')
export const MaleUser = icon('orion-svg-sprite_male-user-1')
